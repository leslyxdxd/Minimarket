namespace Minimarket_GUI
{
    partial class frmListaRemision
    {
        ...
        private void InitializeComponent()
        {
            ...
            dtgRemision.Columns.AddRange(new DataGridViewColumn[] { Id_Remision, Id_Proveedor, Nom_Proveedor, RUC, Telefono, Correo, Id_Producto, Nom_Producto, Id_Cat, FechaIni, FechaFin, Des_Cat, PrecioUnitario, Cantidad, total, Observaciones, Estado });
